      ...
      rollupOptions: {
        output: {
          manualChunks: (id, meta) => {
            ...
            if (id.includes("node_modules/@txnlab/")) {
              return "@txnlab";
            }
            ...
            if (
              ...
              id.includes("/node_modules/@evanhahn/lottie")
            ) {
              return "@lottie";
            }
    ...
    starlight({
      ...
      plugins: [
        starlightTypeDoc({
          ...
          entryPoints: [
            "../packages/store-kit/src/index.ts",
            "../packages/store-kit/src/objects/index.ts",
            "../packages/store-kit/src/lodash/index.ts",
          ],
