 ...
 */
export type LodashCreateCallParams = Expand<AppClientBareCallParams & {
    method?: never;
} & {
 ...
 */
export declare class LodashFactory {
    /**
     ...
     */
    getAppClientById(params: AppFactoryAppClientParams): LodashClient;
    /**
     ...
     * @returns The `AppClient`
     */
    getAppClientByCreatorAndName(params: AppFactoryResolveAppClientByCreatorAndNameParams): Promise<LodashClient>;
    /**
     ...
     */
    deploy(params?: LodashDeployParams): Promise<{
        result: {
 ...
 */
export declare class LodashClient {
    /**
     ...
     */
    decodeReturnValue<TSignature extends LodashNonVoidMethodSignatures>(method: TSignature, returnValue: ABIReturn | undefined): MethodReturn<TSignature> | undefined;
    /**
     * Returns a new `LodashClient` client, resolving the app by creator address and name
     * using AlgoKit app deployment semantics (i.e. looking for the app creation transaction note).
     * @param params The parameters to create the app client
     */
    static fromCreatorAndName(params: Omit<ResolveAppClientByCreatorAndName, 'appSpec'>): Promise<LodashClient>;
    /**
     ...
     * @param params The parameters to create the app client
     */
    static fromNetwork(params: Omit<ResolveAppClientByNetwork, 'appSpec'>): Promise<LodashClient>;
    ...
    readonly params: {
         ...
         */
        set: (params: CallParams<LodashArgs["obj"]["set(string,string)void"] | LodashArgs["tuple"]["set(string,string)void"]> & {
            onComplete?: OnApplicationComplete.NoOpOC;
         ...
         * @returns The call params
         */
        get: (params: CallParams<LodashArgs["obj"]["get(string)string"] | LodashArgs["tuple"]["get(string)string"]> & {
            onComplete?: OnApplicationComplete.NoOpOC;
        }) => Promise<AppCallMethodCall>;
        /**
         ...
         * @returns The call params
         */
        remove: (params: CallParams<LodashArgs["obj"]["remove(string)void"] | LodashArgs["tuple"]["remove(string)void"]> & {
            onComplete?: OnApplicationComplete.NoOpOC;
        }) => Promise<AppCallMethodCall>;
        /**
         ...
         * @returns The call params
         */
        concat: (params: CallParams<LodashArgs["obj"]["concat(string,string)void"] | LodashArgs["tuple"]["concat(string,string)void"]> & {
            onComplete?: OnApplicationComplete.NoOpOC;
        }) => Promise<AppCallMethodCall>;
        /**
         ...
         * @returns The call params
         */
        reclaim: (params: CallParams<LodashArgs["obj"]["reclaim(uint64)void"] | LodashArgs["tuple"]["reclaim(uint64)void"]> & {
            onComplete?: OnApplicationComplete.NoOpOC;
        }) => Promise<AppCallMethodCall>;
    };
    /**
    ...
    readonly send: {
         ...
         */
        set: (params: CallParams<LodashArgs["obj"]["set(string,string)void"] | LodashArgs["tuple"]["set(string,string)void"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOpOC;
        }) => Promise<{
            return: (undefined | LodashReturns["set(string,string)void"]);
         ...
         * @returns The call result
         */
        get: (params: CallParams<LodashArgs["obj"]["get(string)string"] | LodashArgs["tuple"]["get(string)string"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOpOC;
        }) => Promise<{
            return: (undefined | LodashReturns["get(string)string"]);
            returns?: ABIReturn[] | undefined | undefined;
            groupId: string;
            txIds: string[];
            confirmations: modelsv2.PendingTransactionResponse[];
         ...
         * @returns The call result
         */
        remove: (params: CallParams<LodashArgs["obj"]["remove(string)void"] | LodashArgs["tuple"]["remove(string)void"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOpOC;
        }) => Promise<{
            return: (undefined | LodashReturns["remove(string)void"]);
            returns?: ABIReturn[] | undefined | undefined;
            groupId: string;
            txIds: string[];
            confirmations: modelsv2.PendingTransactionResponse[];
         ...
         * @returns The call result
         */
        concat: (params: CallParams<LodashArgs["obj"]["concat(string,string)void"] | LodashArgs["tuple"]["concat(string,string)void"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOpOC;
        }) => Promise<{
            return: (undefined | LodashReturns["concat(string,string)void"]);
            returns?: ABIReturn[] | undefined | undefined;
            groupId: string;
            txIds: string[];
            confirmations: modelsv2.PendingTransactionResponse[];
         ...
         * @returns The call result
         */
        reclaim: (params: CallParams<LodashArgs["obj"]["reclaim(uint64)void"] | LodashArgs["tuple"]["reclaim(uint64)void"]> & SendParams & {
            onComplete?: OnApplicationComplete.NoOpOC;
        }) => Promise<{
            return: (undefined | LodashReturns["reclaim(uint64)void"]);
            returns?: ABIReturn[] | undefined | undefined;
            groupId: string;
            txIds: string[];
            confirmations: modelsv2.PendingTransactionResponse[];
     ...
     */
    clone(params: CloneAppClientParams): LodashClient;
    /**
...
export type LodashComposer<TReturns extends [...any[]] = []> = {
     ...
     */
    simulate(): Promise<LodashComposerResults<TReturns> & {
        simulateResponse: SimulateResponse;
    }>;
    simulate(options: SkipSignaturesSimulateOptions): Promise<LodashComposerResults<TReturns> & {
        simulateResponse: SimulateResponse;
    }>;
    simulate(options: RawSimulateOptions): Promise<LodashComposerResults<TReturns> & {
        simulateResponse: SimulateResponse;
    }>;
    /**
